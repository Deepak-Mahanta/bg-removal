  ...
  return (
    <div className="mx-4 lg:mx-44 py-20 xl:py-40">
      <h1 className="text-center text-2xl md:text-3xl lg:text-4xl mt-4 font-semibold bg-gradient-to-r from-gray-900 to-gray-400 bg-clip-text text-transparent">
        Steps to remove backgroung <br />
        image in search
      </h1>

      <div className="flex items-center flex-wrap gap-4 mt-16 xl:mt-24 justify-center">
        <div className="flex items-center gap-4 bg-white  drop-shadow-md p-7 pb-10 rounded hover:scale-105  transition-all duration-500">
